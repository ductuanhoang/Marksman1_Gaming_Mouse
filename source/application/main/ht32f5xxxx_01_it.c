/*********************************************************************************************************//**
 * @file    USBD/HID_Mouse/ht32f5xxxx_01_it.c
 * @version $Rev:: 2970         $
...
//     if (EXTI_GetEdgeStatus(EXTI_CHANNEL_4, EXTI_EDGE_NEGATIVE) == SET) {
//       if (GPIO_ReadInBit(HT_GPIOC, GPIO_PIN_5) == SET) {
//         exti_cnt --;
//       } else {
//         exti_cnt ++;
//       }
...
//     if (EXTI_GetEdgeStatus(EXTI_CHANNEL_4, EXTI_EDGE_POSITIVE) == SET) {
//       if (GPIO_ReadInBit(HT_GPIOC, GPIO_PIN_5) == SET) {
//         exti_cnt ++;
//       } else {
//         exti_cnt --;
...
//   //   if (GPIO_ReadInBit(HT_GPIOC, GPIO_PIN_4) == RESET) {
//   //     exti_cnt ++;
//   //   } else {
//   //     exti_cnt --;
//   //   }
