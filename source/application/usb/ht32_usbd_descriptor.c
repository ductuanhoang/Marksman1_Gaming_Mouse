...
__ALIGN4 static uc8 guUSB_ConfnDesc[] =
{
  ...
  DESC_H2B(DESC_LEN_MOUSE_REPORT),    // bDescriptorLength   2 Total size of the Report descriptor
  ...
  /*--------------------------------------------------------------------------------------------------------*/
  /* Interface descriptor (Keyboard  + Consumer + Vendor specific)                                          */
  /*--------------------------------------------------------------------------------------------------------*/
                              /* Field            Size Description                                          */
                              /*----------------------------------------------------------------------------*/
  DESC_LEN_INF,               // bLength             1 Size of this descriptor in bytes
  ...
  0x01,                       // bNumDescriptors     1 Number of class descriptors (at least 1)
  DESC_TYPE_22_RPOT,          // bDescriptorType     1 REPORT Descriptor Type
  DESC_H2B(DESC_LEN_KB_REPORT + DESC_LEN_VENDOR_REPORT),   // bDescriptorLength   2 Total size of the Report descriptor
...
__ALIGN4 static uc8 guUSB_StringDescManufacture[] =
{
  ...
  DESC_TYPE_03_STR,           // bDescriptorType     1 STRING Descriptor Type
  DESC_CHAR('M'),             // bString             N UNICODE encoded string
  DESC_CHAR('o'),
  DESC_CHAR('r'),
  DESC_CHAR('i'),
  DESC_CHAR('t'),
...
/* Product name: "MORITZWERKE MARKSMAN 1" */
#if (DESC_IPRODUCT == 1)
__ALIGN4 static uc8 guUSB_StringDescProduct[] =
{
  ...
  /*--------------------------------------------------------------------------------------------------------*/
                              /* Field            Size Description                                          */
                              /*----------------------------------------------------------------------------*/
  DESC_STRLEN(22),            // bLength             1 Size of this descriptor in bytes
  DESC_TYPE_03_STR,           // bDescriptorType     1 STRING Descriptor Type
  DESC_CHAR('M'),             // bString             N UNICODE encoded string
  DESC_CHAR('O'),
  DESC_CHAR('R'),
