...
#define DESC_LEN_MOUSE_REPORT             ((u16)(68))
#define DESC_LEN_KB_REPORT                ((u16)(41))
#define DESC_LEN_VENDOR_REPORT            ((u16)(40))
...
#define HID_REPORT_MOUSE_ID               (1U)
#define HID_REPORT_KEYBOARD_ID            (2U)
#define HID_REPORT_CONSUMER_ID            (3U)
#define HID_REPORT_SYSTEM_CTRL_ID         (4U)
